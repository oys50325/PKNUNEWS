...
- 사이트 입장은 가입자와 관리자만 가능합니다.
- 신규가입자는 관리자 또는 부관리자가 승인한 뒤 사이트를 이용할 수 있습니다.
- 신규가입 비밀번호는 숫자 8자리이며, 학번은 2010학번부터 2050학번까지 선택합니다.
- 기본 관리자 계정은 이름 `PKNUNEWS`, 비밀번호 `50321004`입니다.
- 관리자는 승인된 사용자 중 최대 3명을 부관리자로 지정할 수 있습니다.
- 가입자 승인은 관리자와 부관리자만 할 수 있습니다.
- 강제 탈퇴는 관리자만 할 수 있습니다.
- 가입자는 비밀번호 찾기 요청을 보낼 수 있고, 관리자는 요청한 가입자의 비밀번호만 확인할 수 있습니다.
- 관리자가 PDF를 첨부하면 브라우저 안에서 PDF.js로 텍스트와 페이지 이미지를 추출합니다.
